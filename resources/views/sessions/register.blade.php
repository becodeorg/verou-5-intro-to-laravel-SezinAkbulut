...
@section("content")
    ...
    <main class="mx-36 my-12">
        <form class="max-w-sm mx-auto" action="{{ route("handleRegister") }}" method="POST">
            @csrf

            <h1 class="text-3xl">Register here!</h1>
            <div class="my-5">
            ...
            <div class="mb-5">
                ...
                <input name="repeat_password" type="password" id="repeat_password" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
            </div>
